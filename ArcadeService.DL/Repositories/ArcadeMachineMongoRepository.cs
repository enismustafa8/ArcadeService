...
{
    public class ArcadeMachineMongoRepository : ICustomerRepository
    {
        private readonly IOptionsMonitor<MongoDbConfiguration> _mongoDbConfiguration;
        private readonly ILogger<ArcadeMachineMongoRepository> _logger;
        private readonly IMongoCollection<Customer> _customersCollection;

        public ArcadeMachineMongoRepository(
            IOptionsMonitor<MongoDbConfiguration> mongoDbConfiguration,
            ILogger<ArcadeMachineMongoRepository> logger)
        {
